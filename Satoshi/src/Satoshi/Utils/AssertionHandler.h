...
inline bool Satoshi::AssertionHandler::IsValidPrimitive()
{
	...
	validStringTypes[0] = AssertTypeIDs<String, std::u16string>();
	validStringTypes[0] = AssertTypeIDs<String, std::u32string>();
	validStringTypes[0] = AssertTypeIDs<String, std::wstring>();
